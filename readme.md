...
GOPROXY=direct go get github.com/korlvs/event-logging/libs/go-outbox@libs/go-outbox/v0.10.0

git tag libs/go-outbox/v0.10.0
git push origin libs/go-outbox/v0.10.0
