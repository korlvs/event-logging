...
type Event struct {
	...
	StateBefore   *structpb.Struct       `protobuf:"bytes,6,opt,name=state_before,json=stateBefore,proto3" json:"state_before,omitempty"`
	StateAfter    *structpb.Struct       `protobuf:"bytes,7,opt,name=state_after,json=stateAfter,proto3" json:"state_after,omitempty"`
...
func (x *Event) GetStateBefore() *structpb.Struct {
	if x != nil {
...
func (x *Event) GetStateAfter() *structpb.Struct {
	if x != nil {
		return x.StateAfter
	}
	return nil
...
const file_event_v1_event_proto_rawDesc = "" +
	"\n" +
	"\x14event/v1/event.proto\x12\bevent.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xed\x02\n" +
	"\x05Event\x12\x0e\n" +
	...
	"\fstate_before\x18\x06 \x01(\v2\x17.google.protobuf.StructR\vstateBefore\x128\n" +
	"\vstate_after\x18\a \x01(\v2\x17.google.protobuf.StructR\n" +
	"stateAfter\x12\x1d\n" +
	"\n" +
	"change_tag\x18\b \x01(\tR\tchangeTagB+Z)github.com/korlvs/event-contract/event/v1b\x06proto3"
...
var file_event_v1_event_proto_depIdxs = []int32{
	...
	2, // 2: event.v1.Event.state_before:type_name -> google.protobuf.Struct
	2, // 3: event.v1.Event.state_after:type_name -> google.protobuf.Struct
